<template>
	<v-container :title="t('menus.schools.detail')">
			...
			<VTab
				...
				:class="{
					'text-color-tabs-active border-color-tabs-active':
						getActive(tab.value),
					'text-color-tabs border-color-tabs': !getActive(tab.value),
				}"
			>
		...
		>
			...
			>
				...
				>
					...
					<div class="grid grid-cols-2 gap-4">
						<div>
							{{ t('schools.form.neighborhoodAssociation') }} /
							{{ t('schools.form.citizensAssociation') }}
						</div>
