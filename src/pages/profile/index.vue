      ...
      <form class="space-y-6" action="#" method="POST">
        <div class="px-4 py-5  sm:p-6">
          <div class="md:grid md:grid-cols-3 md:gap-6 ">
            <div class="md:col-span-1 shadow sm:rounded-xl">
            ...
            <div class="mt-5 space-y-6 md:col-span-2 md:mt-0 shadow sm:rounded-lg ">
              ...
              <div>
                ...
                <div class="mt-1">
                  <textarea id="about" name="about" rows="3" class="block w-full rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="you@example.com"></textarea>
                </div>
