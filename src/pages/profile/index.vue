      ...
      <template #content>
        <ProfileLayout>
          <template #profile-side>
            <div class="py-[30px] px-[12px] bg-white rounded-[4px] border border-[#E3E6EA] lg:h-[17.688rem] lg:w-[12.5rem]">
              <div class="grid grid-cols-1 gap-[1.25rem] h-full">
                <div class="flex flex-col items-center">
                  <div
                    class="max-w-xs h-[5.75rem] w-[5.75rem] bg-secondary-light text-white text-[30px] flex items-center justify-center text-2xl font-bold rounded-full ">
                    {{ user.profile }}
                  </div>
