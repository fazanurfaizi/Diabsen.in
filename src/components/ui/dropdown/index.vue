<template>
	<div class="relative inline-flex">
		<button
			ref="trigger"
			class="btn bg-gray-100 p-3 border-gray-200 hover:border-gray-300 text-gray-500 hover:text-gray-600"
			aria-haspopup="true"
		...
		>
			<div
				v-show="dropdownOpen"
				class="origin-top-right z-10 absolute top-full min-w-max bg-white border border-gray-200 pt-1.5 rounded shadow-lg overflow-hidden mt-1"
