	...
	<ul class="relative" v-if="typeof data.child !== 'undefined'">
		<li class="relative" id="sidenavEx1">
			<a
				...
				"
				class="flex items-center text-md py-[10px] pl-[12px] pr-[2px] overflow-hidden text-ellipsis whitespace-nowrap rounded-md transition duration-300 ease-in-out cursor-pointer"
			...
			>
				<li class="relative" v-for="item in data.child" :key="item">
					<router-link
						...
						class="flex items-center py-[10px] pl-[12px] pr-[2px] overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded-md hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out"
						data-mdb-ripple="true"
						data-mdb-ripple-color="dark"
					>
						<Icon
