<template>
	<div class="md:block" :class="sidebarOpen ? 'sticky' : 'hidden'">
		...
		>
			<div class="px-1.5 py-1.5 transition duration-150">
				...
				<heroicons-outline-vue
					...
					class="w-3 h-3 fill-current sidebar-expanded:rotate-180 text-white transition duration-150"
				/>
			</div>
		</button>
			...
			<div class="space-y-4">
				...
				>
					<div>
						...
						<ul class="mt-1">
							<template
								v-for="(menu, menuIndex) in route.items"
								:key="`menu-${menuIndex}`"
							>
								<SidebarLink
									v-slot="parentLink"
								...
								>
									<a
										...
										:class="
											parentLink.expanded && 'bg-gray-300'
										"
										href="#0"
										@click.prevent="
											sidebarExpanded
