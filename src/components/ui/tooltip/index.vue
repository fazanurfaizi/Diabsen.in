		...
		setup() {
			...
			const positionOuterClasses = (position) => {
				switch (position) {
					...
					case 'left':
						return 'rigth-full top-1/2 transform -translate-y-1/2'
					case 'bottom':
						return 'top-full top-1/2 transform -translate-x-1/2'
					default:
						return 'bottom-full top-1/2 transform -translate-x-1/2'
				}
			}
